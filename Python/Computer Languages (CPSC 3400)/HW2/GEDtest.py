...
def runKennedyTests():
    ...
    if doPrint in 'yY':
        print()
        getPerson("I54").printCousins(10)  # Caroline KENNEDY
        print()
        getPerson("I82").printCousins(10)  # Edwin Moore KENNEDY Jr.
        print()
        getPerson("I1").printCousins(10)  # Joseph Patrick Kennedy
        print()
        getPerson("I49").printCousins(2)   # Janet LEE
        print()
